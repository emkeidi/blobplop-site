...
draft: false
description: Watch as I toss a few prompts
date: 2023-07-01
authors:
  - name: Matthew Davis
    title: Co-creator of BlobPlop
  - name: Ghost Writer
    title: Haunting Expert
cover: '../../assets/monitor-g260a5baac_1280.jpg'
coverAlt: 'Personal PowerShell terminal of the author that is customized with whimsical emojis.'
category: Learning
---
...
:::assert{title="ChatGPT Prompt"}

To kick things off, I provided a simple prompt to your friend and mine, ChatGPT:

> useful PowerShell scripts every developer needs

That's it. That's the whole quote. Let's see how far that can go with some additional prompts.
...
<div class='prose-strong:text-red-100'>
:::commend{title="ChatGPT Response"}
...
:::warn{title="Running AI-Generated Scripts"}
